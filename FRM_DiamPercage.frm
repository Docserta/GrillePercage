...
Dim NumMachine As String
    If Me.CBL_NumMachine <> "" Then
        ...
        ElseIf Me.RB_GrillePM Then
            Me.TBX_DiamPercage = CollBagues.Item(NumMachine).DNom
...
'Masque ou affiche les champs Vis Arretoire
...
'Affiche ou masque les champs Lamage
    Me.CB_Lamage.Visible = Visible
    Me.LB_DiamLamage.Visible = Visible
    Me.TBX_DiamLamage.Visible = Visible
End Sub

Private Sub EnabledChampsLamage(Enab As Boolean)
'Active ou désactive les controles Lamage
    Me.LB_DiamLamage.enabled = Enab
    Me.TBX_DiamLamage.enabled = Enab
End Sub

Private Sub AffChampsVis(Visible As Boolean)
'Active ou désactive les controles VisArretoir
    Me.LB_NumBague.Visible = Visible
    Me.TBX_NumBague.Visible = Visible
